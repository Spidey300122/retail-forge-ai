        ...
        {activeTab === 'text' && (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full px-4 py-3 bg-gray-600 text-white rounded hover:bg-gray-700 text-left"
            >
            ...
            <button
              ...
              className="w-full px-4 py-3 bg-gray-500 text-white rounded hover:bg-gray-600 text-left"
            >
